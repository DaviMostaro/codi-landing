      ...
      <div className="mx-auto max-w-7xl px-6 py-20 sm:py-28">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {pillars.map((pillar) => (
            <article
              key={pillar.number}
              className="flex h-full flex-col rounded-2xl border border-codi-border border-t-2 border-t-codi-primary bg-codi-card p-8"
            >
              <div className="flex items-center justify-between">
                <span className="flex h-11 w-11 items-center justify-center rounded-lg bg-codi-card text-codi-primary">
              ...
              <ul className="mt-auto flex flex-wrap gap-2 pt-6">
                {pillar.techs.map((tech) => (
                  <li
                    key={tech}
                    className="rounded-full border border-codi-border bg-codi-card px-3 py-1 text-sm text-codi-text"
                  >
                    {tech}
                  </li>
                ))}
