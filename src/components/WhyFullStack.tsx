...
export function WhyFullStack() {
  return (
    <section id="curso" className="bg-codi-soft-bg">
      <div className="mx-auto max-w-7xl px-6 py-20 sm:py-28">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="mt-4 max-w-2xl text-3xl font-bold tracking-tight text-codi-text sm:text-4xl">
            Por que aprender{" "}
            <span className="text-codi-text-accent">Full Stack</span>?
          </h2>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {reasons.map((reason) => (
            <article
              key={reason.title}
              className="flex flex-col rounded-2xl border border-codi-border bg-codi-card p-8"
            >
